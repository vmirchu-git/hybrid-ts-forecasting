...
def main():
    ...
    model_path = project_root / "results" / "models" / "regression_t_plus_5_model.pth"
    ...
    print(f"Baseline RMSE (t+5): {baseline_rmse:.6f}")


def prepare_data(data_path: Path):
    """Runs preprocessing pipeline for horizon=5."""
